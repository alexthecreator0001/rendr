...
const SAMPLE: Record<string, string> = {
  ...
  // Shipping Label
  carrier: "FedEx",
  service_type: "Express 2-Day",
  tracking_number: "7489 2840 1137 5520",
  sender_city: "New York, NY 10001",
  recipient_city: "Los Angeles, CA 90012",
  ship_date: "January 15, 2024",
  weight: "2.4 lbs",
  order_number: "ORD-2024-1847",
  // Event Ticket
  event_type: "Live Concert",
  event_name: "Midnight Jazz Festival",
  event_date: "March 22, 2024",
  event_time: "8:00 PM",
  venue: "The Blue Note",
  attendee_name: "Alex Rivera",
  ticket_number: "TIX-00482",
  seat: "Floor A — Row 3",
  ticket_price: "$75.00",
  // NDA
  disclosing_party: "Acme Corp",
  receiving_party: "Digital Studio LLC",
  definition_clause: "Confidential Information includes all non-public information disclosed by the Disclosing Party, whether orally, visually, or in writing, that is designated as confidential or should reasonably be understood to be confidential.",
  obligations_clause: "The Receiving Party shall use the Confidential Information solely for the purpose of evaluating or engaging in the proposed business relationship and shall not disclose it to any third party without prior written consent.",
  duration: "2 years",
  governing_law: "State of Delaware, United States",
  // Packing Slip
  ship_to_name: "Jane Smith",
  ship_to_address: "456 Oak Avenue, Apt 12\nChicago, IL 60601",
  order_date: "January 15, 2024",
  shipping_method: "Standard (3-5 days)",
  item1_name: "Wireless Keyboard — Space Gray", item1_sku: "KB-2024-SG", item1_qty: "1",
  item2_name: "USB-C Hub 7-in-1", item2_sku: "HUB-7IN1", item2_qty: "1",
  item3_name: "Desk Cable Organizer", item3_sku: "ORG-BLK-01", item3_qty: "2",
  packing_notes: "Handle with care. Gift wrapping requested — do not include pricing.",
  // Meeting Minutes
  meeting_title: "Q1 Product Roadmap Review",
  meeting_date: "January 20, 2024",
  meeting_time: "2:00 PM — 3:30 PM",
  location: "Conference Room B / Zoom",
  attendee1: "Sarah Chen",
  attendee2: "James Park",
  attendee3: "Lisa Nguyen",
  attendee4: "Mark Davis",
  agenda: "1. Review Q4 metrics and outcomes\n2. Discuss Q1 feature priorities\n3. Resource allocation for mobile app\n4. Timeline for API v2 launch",
  discussion: "The team reviewed Q4 results, noting a 15% increase in user engagement. Discussion focused on prioritizing the mobile app redesign vs. API v2. After debate, the team agreed to run both in parallel with dedicated squads.",
  action1_owner: "Sarah", action1_task: "Draft mobile app wireframes", action1_due: "Jan 27",
  action2_owner: "James", action2_task: "Finalize API v2 spec document", action2_due: "Jan 31",
  action3_owner: "Lisa", action3_task: "Set up user research interviews", action3_due: "Feb 3",
  next_meeting: "January 27, 2024 at 2:00 PM — Conference Room B",
  recorder: "Lisa Nguyen",
  // Gift Card
  brand_name: "Luxe & Co.",
  message: "Happy Birthday! Wishing you all the best on your special day.",
  from_name: "Sarah",
  to_name: "Michael",
  redemption_code: "GIFT-X8K2-M9PL",
  // Resume
  full_name: "Alexandra Johnson",
  job_title: "Senior Product Designer",
  phone: "+1 (555) 234-5678",
  website: "alexjohnson.design",
  skill1: "UI/UX Design", skill2: "Figma & Sketch", skill3: "Design Systems", skill4: "Prototyping",
  language1: "English — Native", language2: "Spanish — Conversational",
  profile_summary: "Product designer with 8+ years of experience crafting intuitive digital experiences for SaaS platforms. Passionate about design systems, accessibility, and bridging the gap between design and engineering.",
  exp1_role: "Senior Product Designer", exp1_dates: "2021 — Present", exp1_company: "TechCorp Inc.", exp1_desc: "Led redesign of the core product dashboard, improving user engagement by 34%. Built and maintained a design system used across 5 product teams.",
  exp2_role: "Product Designer", exp2_dates: "2018 — 2021", exp2_company: "StartupXYZ", exp2_desc: "Designed end-to-end user experiences for a B2B analytics platform. Conducted user research, created wireframes, and delivered pixel-perfect designs.",
  edu_degree: "B.A. in Visual Communication", edu_dates: "2014 — 2018", edu_school: "Rhode Island School of Design",
  // Pay Stub
  employee_name: "Michael Brown",
  employee_id: "EMP-4821",
  department: "Engineering",
  pay_period: "Jan 1 — Jan 15, 2024",
  pay_date: "January 20, 2024",
  regular_hours: "80", regular_pay: "$5,384.62",
  overtime_hours: "6", overtime_pay: "$605.77",
  bonus: "$500.00",
  gross_pay: "$6,490.39",
  federal_tax: "$1,038.46",
  state_tax: "$324.52",
  social_security: "$402.40",
  health_insurance: "$185.00",
  total_deductions: "$1,950.38",
  net_pay: "$4,540.01",
  // Boarding Pass
  airline: "SkyLine Airways",
  origin_code: "JFK", origin_city: "New York",
  dest_code: "LAX", dest_city: "Los Angeles",
  passenger_name: "A. JOHNSON",
  flight_number: "SL 482",
  flight_date: "15 MAR",
  boarding_time: "7:35 PM",
  gate: "B22",
  // Quote
  quote_number: "QT-2024-0089",
  valid_until: "February 28, 2024",
  issue_date: "January 15, 2024",
  qt_item1_desc: "Website Design & Development", qt_item1_qty: "1", qt_item1_price: "$4,800.00", qt_item1_total: "$4,800.00",
  qt_item2_desc: "SEO Optimization Package", qt_item2_qty: "1", qt_item2_price: "$1,200.00", qt_item2_total: "$1,200.00",
  qt_item3_desc: "Monthly Maintenance (3 mo)", qt_item3_qty: "3", qt_item3_price: "$300.00", qt_item3_total: "$900.00",
  quote_notes: "Payment: 50% upfront, 50% on delivery. Timeline: 6-8 weeks from project kickoff. This quote is valid for 30 days from the issue date.",
  // Warranty Card
  warranty_brand: "TechPro",
  product_name: "UltraBook Pro 16\"",
  serial_number: "TP-2024-X8K2M9",
  model_number: "UBP-16-512",
  purchase_location: "TechPro Store — NYC",
  purchase_date: "Jan 15, 2024",
  warranty_expiry: "Jan 15, 2026",
  coverage_details: "This warranty covers manufacturing defects and hardware failures under normal use for 24 months from the date of purchase. Accidental damage, water damage, and unauthorized modifications are not covered.",
  support_email: "support@techpro.com",
  // Donation Receipt
  ein_number: "12-3456789",
  organization_address: "100 Charity Lane, San Francisco, CA 94102",
  donation_amount: "$500",
  donation_type: "One-time monetary contribution",
  donor_name: "Robert Chen",
  donor_address: "456 Executive Blvd, New York, NY 10022",
  donation_date: "January 15, 2024",
  donation_purpose: "General Fund — Education Programs",
};
