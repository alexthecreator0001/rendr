            ...
            <div>
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                {([
                  ...
                  { icon: Layers,             title: "Google Sheets to PDF",  desc: "Connect a spreadsheet, map columns to template variables, batch-render one PDF per row. Perfect for invoices and reports." },
                ] as const).map((f) => (
