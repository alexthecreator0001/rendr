      ...
      <div className="rounded-2xl bg-gradient-to-b from-emerald-500/20 via-blue-500/10 to-transparent p-[1px]">
        <div className="overflow-hidden rounded-2xl bg-zinc-950">
          <div className="relative w-full" style={{ padding: "53.75% 0 0 0" }}>
            {playing ? (
              <iframe
                src="https://player.vimeo.com/video/1171585294?badge=0&autopause=0&player_id=0&app_id=58479&autoplay=1&title=0&byline=0&portrait=0"
                frameBorder="0"
              ...
              >
                ...
                <img
                  src="https://vumbnail.com/1171585294.jpg"
                  alt="Video thumbnail"
